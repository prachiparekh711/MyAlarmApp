...
class DaySwitch : View, View.OnClickListener, Subscribblable {
    ...
    private var textPaint: Paint = Paint().apply {
        isAntiAlias = true
        textSize = DimenUtils.dpToPx(15f).toFloat()
            ...
            if (isChecked != this.isChecked) {
                ...
                run {
                    if (isChecked) {
                        ...
                        this.background =
                            context?.resources?.getDrawable(R.drawable.togglebutton_off)
    ...
    override fun subscribe() {
        ...
        textColorPrimaryInverseSubscription = Aesthetic.get()
            ...
            .subscribe { integer ->
                ...
                clippedTextPaint.color = resources.getColor(R.color.black)
                invalidate()
            }
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        text?.let { str ->
            ...
            val circleWidth = DimenUtils.dpToPx(30f)
