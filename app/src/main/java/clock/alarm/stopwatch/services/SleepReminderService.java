...
public class SleepReminderService extends Service {
     ...
     */
    @Nullable
    public static AlarmData getSleepyAlarm(AlarmApp alarmio) {
     ...
     */
    @Nullable
    public static AlarmData getNextWakeAlarm(AlarmApp alarmio) {
    ...
    public static void refreshSleepTime(Context context) {
        ...
        AlarmApp alarmio;
        if (context instanceof AlarmApp)
            alarmio = (AlarmApp) context;
        else alarmio = (AlarmApp) context.getApplicationContext();
