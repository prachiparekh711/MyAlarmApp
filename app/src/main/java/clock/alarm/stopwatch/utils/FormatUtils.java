package clock.alarm.stopwatch.utils;
...
public class FormatUtils {
    ...
    public static final String FORMAT_12H_SHORT1 = "h:mm";
    public static final String FORMAT_12H_SHORT2 = "a";
    public static final String FORMAT_12H1 = "h:mm:ss a";
    ...
    public static String format1(Context context, Date time) {
        return format(time, FORMAT_12H_SHORT);
    }

    public static String format2(Context context, Date time) {
        return format(time, FORMAT_12H1);
    }
    ...
    public static String formatShort1(Context context, Date time) {
        return format(time, DateFormat.is24HourFormat(context) ? FORMAT_24H_SHORT : FORMAT_12H_SHORT1);
    }

    public static String formatShort2(Context context, Date time) {
        return format(time, DateFormat.is24HourFormat(context) ? FORMAT_24H_SHORT : FORMAT_12H_SHORT2);
    }
    ...
    public static String formatMillis1(long millis) {
        long hours = TimeUnit.MILLISECONDS.toHours(millis);
        long minutes = TimeUnit.MILLISECONDS.toMinutes(millis) % TimeUnit.HOURS.toMinutes(1);
        long seconds = TimeUnit.MILLISECONDS.toSeconds(millis) % TimeUnit.MINUTES.toSeconds(1);
        long micros = TimeUnit.MILLISECONDS.toMicros(millis) % TimeUnit.SECONDS.toMicros(1) / 10000;
