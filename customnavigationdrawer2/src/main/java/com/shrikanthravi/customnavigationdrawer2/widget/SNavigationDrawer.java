...
public class SNavigationDrawer extends RelativeLayout {
    ...
    private final BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            appbarTitleTV.setText(message);
        }
    };
    //Customization Variables
    private int appbarColor = R.color.Black;
    private int appbarTitleTextColor = R.color.White;
    ...
    protected void initMenu() {
        for (int i = 0; i < menuItemList.size(); i++) {
            ...
            ImageView backgroundIVSmall = view.findViewById(R.id.backgroundIVSmall);
            ImageView backgroundIVSmall1 = view.findViewById(R.id.backgroundIVSmall1);
...
//            titleTV.setTextColor(secondaryMenuItemTextColor);
            ...
            backgroundIVSmall.setTag("img" + i);
            System.out.println("Testing " + backgroundCV.getTag());
            titleTV.setTag("tv" + i);
            backgroundIVSmall1.setTag("si" + i);
            if (i >= 1) {
                ...
                backgroundIVSmall1.setVisibility(View.VISIBLE);
            } else {
                titleTV.setVisibility(View.GONE);
                backgroundIVSmall1.setVisibility(View.GONE);
            }
            rootRL.setTag(i);

            if (currentPos == 1 || currentPos == 5) {
                appbarTitleTV.setText(menuItemList.get(currentPos).getTitle());
            }
            if (currentPos == 0) {
                appbarTitleTV.setText("Alarm");
            }
            rootRL.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (currentPos != Integer.valueOf(view.getTag().toString())) {
                        ...
                        final ImageView img1 = menuLL.findViewWithTag("si" + currentPos);
                        final ImageView backgroundIVSmallImg = menuLL.findViewWithTag("img" + currentPos);
//                        backgroundIVSmallImg.setColorFilter(ContextCompat.getColor(getContext(), R.color.White), android.graphics.PorterDuff.Mode.SRC_IN);
                        ...
                        final ImageView img = menuLL.findViewWithTag("si" + currentPos);
                        ...
                        handler1.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                backgroundIVSmallImg.setVisibility(View.VISIBLE);
            ...
            backgroundIVSmall.setImageDrawable(getContext().getDrawable(menuItemList.get(i).getImageIdSmall()));
            backgroundIVSmall1.setImageDrawable(getContext().getDrawable(menuItemList.get(i).getImageIdSmall()));
